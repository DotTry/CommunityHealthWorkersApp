...
vmaControllerModule.controller('menuCtrl', ['$scope', '$state', '$ionicSideMenuDelegate', '$ionicUser', '$rootScope', '$ionicPush', function($scope, $state, $ionicSideMenuDelegate, $ionicUser, $rootScope, $ionicPush) {
